$(document).ready(function() {
  ...
  var gameWords = new Array("H-elp", "Find/earch", "N-orth", "S-outh", "W-est", "E-east','A-About");

  //All the rooms in the game
  var rooms = new Array("Winterfell", "Courtyard", 'The Wall', "The Fork", "Castle Black", "Beyond the Wall", 'Hardhome', "Riverlands",
    "The Twins", "King's Landing", "The Red Tree", "Pentos", "Mereen", "Vaes Dothrak", "Old Tunnel", "Cold Room",
  ...
  var GameObjects = new Array('', "Dagger", "Knife", "Ice", "Valyrian Steel", "Oathbreaker", "Helm of the Hound", "Longclaw", "Candle", "Torch", "Iron Shield", "Armor", "Chain Mail", "AXE", "ROPE", "BOAT", "AEROSOL", "CANDLE", "KEY");
  ...
  function DisplayGameScreen() {
    ...
    DisplayText("<h3>You are now in: " + rooms[currentRoom] + "</h3>");
    DisplayText("<h3> Exits: " + ShowAdjacentRooms(exits[currentRoom]) + "<h3><br/>");
